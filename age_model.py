...
test_model.load_state_dict(torch.load('/root/WORKSPACE/classification/saved_model/age_model.pt'))


# In[29]:


age_pred=inference(test_model, test_loader, device)


# In[33]:


df_age=pd.DataFrame({'ImageID':test_data['ImageID'], 'age':age_pred})


# In[35]:


df_age.to_csv('/root/WORKSPACE/df_age.csv', index=False)
